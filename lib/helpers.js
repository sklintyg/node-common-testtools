module.exports = {
    intygShortcode: {
        ...
        //'TSTRK1007': 'Transportstyrelsens läkarintyg', <-- Gammal shortcode?
		'TS-BAS' : 'Transportstyrelsens läkarintyg',
        //'TSTRK1031': 'Transportstyrelsens läkarintyg, diabetes' <-- Gammal shortcode?
